...
TRAIN_IMAGES_DIR = os.path.join("dataset_old","train", "images")
TRAIN_IMAGES_DIR = os.path.abspath(TRAIN_IMAGES_DIR)
TRAIN_SELFIES_DIR = os.path.join("dataset", "train", "images")
TRAIN_SELFIES_DIR = os.path.abspath(TRAIN_SELFIES_DIR)
TEST_IMAGES_DIR = os.path.join("dataset_old", "test", "images")
TEST_IMAGES_DIR = os.path.abspath(TEST_IMAGES_DIR)
TEST_SELFIES_DIR = os.path.join("dataset", "test", "images")
TEST_SELFIES_DIR = os.path.abspath(TEST_SELFIES_DIR)
PREPROCESSED_TRAIN_IMAGES_DIR = os.path.join("dataset_old", "train", "preprocessed_images")
PREPROCESSED_TRAIN_IMAGES_DIR = os.path.abspath(PREPROCESSED_TRAIN_IMAGES_DIR)
PREPROCESSED_TRAIN_SELFIES_DIR = os.path.join("dataset", "train", "preprocessed_images")
PREPROCESSED_TRAIN_SELFIES_DIR = os.path.abspath(PREPROCESSED_TRAIN_SELFIES_DIR)
PREPROCESSED_TEST_IMAGES_DIR = os.path.join("dataset_old", "test", "preprocessed_images")
PREPROCESSED_TEST_IMAGES_DIR = os.path.abspath(PREPROCESSED_TEST_IMAGES_DIR)
PREPROCESSED_TEST_SELFIES_DIR = os.path.join("dataset", "test", "preprocessed_images")
PREPROCESSED_TEST_SELFIES_DIR = os.path.abspath(PREPROCESSED_TEST_SELFIES_DIR)


TRAIN_MASKS_DIR = os.path.join("dataset_old", "train", "masks")
TRAIN_MASKS_DIR = os.path.abspath(TRAIN_MASKS_DIR)
TRAIN_SELFIES_MASKS_DIR = os.path.join("dataset", "train", "masks")
TRAIN_SELFIES_MASKS_DIR = os.path.abspath(TRAIN_SELFIES_MASKS_DIR)
TEST_MASKS_DIR = os.path.join("dataset_old", "test", "masks")
TEST_MASKS_DIR = os.path.abspath(TEST_MASKS_DIR)
TEST_SELFIES_MASKS_DIR = os.path.join("dataset", "test", "masks")
TEST_SELFIES_MASKS_DIR = os.path.abspath(TEST_SELFIES_MASKS_DIR)
PREPROCESSED_TRAIN_MASKS_DIR = os.path.join("dataset_old", "train", "preprocessed_masks")
PREPROCESSED_TRAIN_MASKS_DIR = os.path.abspath(PREPROCESSED_TRAIN_MASKS_DIR)
PREPROCESSED_TRAIN_SELFIES_MASKS_DIR = os.path.join("dataset", "train", "preprocessed_masks")
PREPROCESSED_TRAIN_SELFIES_MASKS_DIR = os.path.abspath(PREPROCESSED_TRAIN_SELFIES_MASKS_DIR)
PREPROCESSED_TEST_MASKS_DIR = os.path.join("dataset_old", "test", "preprocessed_masks")
PREPROCESSED_TEST_MASKS_DIR = os.path.abspath(PREPROCESSED_TEST_MASKS_DIR)
PREPROCESSED_TEST_SELFIES_MASKS_DIR = os.path.join("dataset", "test", "preprocessed_masks")
