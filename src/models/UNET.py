...
class UNET(nn.Module):
    def __init__(self, in_channels: int = 1, out_channels: int = 1, channel_factor: int = 32):
        ...
        # bottleneck
        self.bottleneck = ConvBlock(channel_factor * 2, channel_factor * 4, kernel_size=3, padding=1)
